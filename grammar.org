...
** Non LL(1) grammar
   ...
   #+BEGIN_EXAMPLE
     ...
     escribir : tESCRIBIR tPAR_IZQ lista_argumentos_no_vacia tPAR_DCHA ;
     asignacion : tID tOPAS argumento tPUNTOCOMA ;
     ...
     argumento : tKCADENA | entacar | expresion_bool ;
     lista_argumentos_vacia : argumento repeticion_argumentos | ;
     lista_argumentos_no_vacia : argumento repeticion_argumentos ;
     repeticion_argumentos : tCOMA argumento repeticion_argumentos | ;
     ...
     factor_arit : tKENTERO | tID | caraent | tKCARACTER | tPAR_IZQ expresion_bool tPAR_DCHA ;
     %%
   #+END_EXAMPLE
...
** LL(1) grammar
   ...
   #+BEGIN_EXAMPLE fundamental
     ...
     asignacion : tOPAS argumento tPUNTOCOMA ;
     invocacion_accion : argumentos_accion tPUNTOCOMA ;
     mientras_que : tMQ expresion_bool lista_sentencias tFMQ ;
     seleccion : tSI seleccion' ;
     argumentos_accion : tPAR_IZQ lista_argumentos_vacia tPAR_DCHA | ;
     argumento : tKCADENA | entacar | expresion_bool ;
     lista_argumentos_vacia : | tKCADENA repeticion_argumentos | entacar repeticion_argumentos | expresion_bool repeticion_argumentos ;
     lista_argumentos_no_vacia : tKCADENA repeticion_argumentos | entacar repeticion_argumentos | expresion_bool repeticion_argumentos ;
     repeticion_argumentos : tCOMA argumento repeticion_argumentos | ;
     operador_relacional : tMAYOR | tMENOR | tIGUAL | tMAI | tMEI | tNI ;
     ...
     factor_arit_unario : tMAS factor_arit | tMENOS factor_arit | factor_arit ;
     factor_arit : tKENTERO | tID | tKCARACTER | tPAR_IZQ expresion_bool tPAR_DCHA | tCARAENT factor_arit' ;
